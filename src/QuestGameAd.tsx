...
const handleRedirectToLink = (props:any) =>{
    ...
    >
      ...
      <nav className="border-b border-slate-800 sticky top-0 z-30 bg-slate-950/85 backdrop-blur">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <button className="bg-amber-400 text-slate-950 font-semibold text-sm px-5 py-2.5 rounded-lg hover:bg-amber-300 transition-colors">
            Quest Store'da Al
          </button>
        </div>
      </nav>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8">
            <button className="bg-amber-400 text-slate-950 font-semibold px-7 py-3.5 rounded-lg flex items-center gap-2 hover:bg-amber-300 transition-colors" onClick ={() =>handleRedirectToLink("https://www.meta.com/en-gb/experiences/?srsltid=AfmBOoohQCaStk-g2iq90RKoQV5fkTH53M6TmyAnvaQZBZhSKaapQqWv")}>
              Şimdi İndir — ₺149
      ...
      <section className="border-t border-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button className="bg-amber-400 text-slate-950 font-semibold px-8 py-4 rounded-lg flex items-center gap-2 hover:bg-amber-300 transition-colors whitespace-nowrap">
